    ...
    <link rel="stylesheet" href="assets/css/style.min.css"> -->
        ...
        <body>
            ...
            <div class="main-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-5">
                                        <div class="header-offer-wrap">
                                            <p><i class="icon-paper-plane"></i> FREE SHIPPING world wide for all orders
                                                over <span>$199</span></p>
                                        </div>
                                    </div>
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        <a class="dropdown-title" href="#">Shop
                                                                            Layout</a>
                                                                        <ul>
                                                                            <li><a href="shop.html">standard style</a>
                                                                            </li>
                                                                            <li><a href="shop-list.html">shop list
                                                                                    style</a></li>
                                                                            <li><a href="shop-fullwide.html">shop
                                                                                    fullwide</a></li>
                                                                            <li><a href="shop-no-sidebar.html">grid no
                                                                                    sidebar</a></li>
                                                                            <li><a href="shop-list-no-sidebar.html">list
                                                                                    no sidebar</a></li>
                                                                    ...
                                                                    <li>
                                                                        <a class="dropdown-title"
                                                                            href="#">Products Layout</a>
                                                                        <ul>
                                                                            <li><a href="product-details.html">tab
                                                                                    style 1</a></li>
                                                                            <li><a href="product-details-2.html">tab
                                                                                    style 2</a></li>
                                                                            ...
                                                                            <li><a href="product-details-gallery.html">gallery
                                                                                    style </a></li>
                                                                            <li><a
                                                                                    href="product-details-affiliate.html">affiliate
                                                                                    style</a></li>
                                                                            <li><a href="product-details-group.html">group
                                                                                    style</a></li>
                                                                            <li><a
                                                                                    href="product-details-fixed-img.html">fixed
                                                                                    image style </a></li>
                                                                        </ul>
                                                                    </li>
                                                                    <li>
                                ...
                                <div class="col-7">
                                    <div class="header-action header-action-flex">
                                        ...
                                        <div class="same-style-2 main-menu-icon">
                                            <a class="mobile-header-button-active" href="#"><i
                                                    class="icon-menu"></i> </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mobile-header-content-area">
                                            ...
                                            <ul class="dropdown">
                                                <li class="menu-item-has-children"><a href="#">shop layout</a>
                                                    <ul class="dropdown">
                                                        ...
                                                        <li><a href="shop-list-no-sidebar.html">list no sidebar</a>
                                                        </li>
                                                ...
                                                <li class="menu-item-has-children"><a href="#">Products
                                                    ...
                                                    <ul class="dropdown">
                                                        ...
                                                        <li><a href="product-details-fixed-img.html">fixed image style
                                                            </a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                            ...
                            <div class="mobile-header-info-wrap mobile-header-padding-border-3">
                                <div class="single-mobile-header-info">
                                    <a href="order-tracking.html"><i class="lastudioicon-pin-3-2"></i> Track Your
                                        Order </a>
                                </div>
                                <div class="single-mobile-header-info">
                ...
                >>>>>>> 989c3c8ec1fb5ef3701abda7d6ab84bc8c7051d0
                <div class="breadcrumb-area bg-gray">
                    <div class="container">
                        <div class="breadcrumb-content text-center">
                            <ul>
                                <li>
                                    <<<<<<< HEAD <a href="{{ route('trang-chu') }}">Home</a>
                                </li>
                ...
                <<<<<<< HEAD <div class="shop-area pt-20 pb-20">
                    =======
                    <div class="blog-area pt-120 pb-120">
                        ...
                        <div class="container">
                            <div class="row flex-row-reverse">
                                <div class="col-lg-9">
                                    <div class="row">
                                        <<<<<<< HEAD @foreach ($lsPost as $post)
                                            <div class="col-lg-6 col-md-6 col-12 col-sm-6">
                                                <div class="blog-wrap mb-40">
                                                    <div class="blog-img mb-20">
                                                        <a
                                                            href="{{ route('chi-tiet-bai-viet', ['id' => $post->id]) }}"><img
        ...
        <div class="col-lg-6 col-md-6 col-12 col-sm-6">
            <div class="blog-wrap mb-40">
                ...
                <div class="blog-content">
                    ...
                    <h1><a href="blog-details.html">Five things you only know if you’re at Chanel's Hamburg Show</a>
                    </h1>
                </div>
            </div>
        </div>
