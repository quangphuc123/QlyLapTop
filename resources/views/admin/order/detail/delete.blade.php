...
@endif
<form action="{{ route('order.detail.destroy', $orderDetail->id) }}" method="post" class="box">
    @csrf
    @method('DELETE')
                ...
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>- Bạn đang muốn xóa ngôn ngữ có Tên: <span
                                class="text-danger">{{ $orderDetail->name }}</span></p>
                            ...
                            <div class="col-lg-12">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="name"
                                        value="{{ old('name', $orderDetail->name ?? '') }}" class="form-control"
