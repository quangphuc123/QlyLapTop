                                ...
                                <tbody>
                                    ...
                                    @foreach ($user->wishlist as $product)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="add_to_cart cart-active" title="Thêm vào giỏ hàng"
                                                ...
                                                <form action="{{ route('delete-wishlist') }}" method="POST">
                                                    ...
                                                    <div class="product-action-2 tooltip-style-2">
                                                        ...
                                                        <input type="hidden" name="product_id"
                                                            value="{{ $product['id'] }}">
                                                        <button type="submit" style="border:none" title="Bỏ thích"><svg
                                                                xmlns="http://www.w3.org/2000/svg" border:none
