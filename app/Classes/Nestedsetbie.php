...
// tham số đầu vào
//hàm get xử lý các tham số đầu vào
//phương thức set
// 1 phương thức đệ quy
// 1 Action
// 1 Dropdown để lấy tất cả các thông tin
    public function Get(){
        ...
        ->select('tb1.id','tb2.name','tb1.parent_id','tb1.lft','tb1.rgt','tb1.level','tb1.oder')
    ...
    public function Action(){
        if(isset($this->level) && is_array($this->level) && isset($this->lft)
        && is_array($this->lft) && isset($this->rgt) && is_array($this->rgt)){
            $data = NULL;
